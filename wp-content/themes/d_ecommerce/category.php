        ...
        <div class="section-top-border">
            <div class="row row-artigos-content">
                ...
                <div class="col-lg-8 col-md-8" style="
                        ...
                        <div data-aos="zoom-in" data-aos-delay="200" data-aos-anchor-placement="top-bottom" class="info-descricao">
                            ...
                            <div> 
                                <a href="<?php echo esc_url(get_permalink()); ?>" class="d-flex align-items-center primary-btn btn-leia-mais-artigos" style="margin-bottom: 3em">
                                    Leia Mais
                ...
                <div class="col-lg-4 col-md-4 ter-colun-artigos">
                    <div class="bloco-pesquisar">
                        ...
                        <!-- <input type="text" class="pesquisa-artigos" placeholder="Pesquisar..." style="background-image:url(<?php bloginfo('template_url'); ?>/images/lupa.png);"> -->
                        <?php get_search_form(); ?>
                        ...
                        <table style="width: 250px;border-bottom: 1px solid #d0d0d0;" data-aos="fade-left" data-aos-delay="200" data-aos-anchor-placement="top-bottom">
                            <tr>
                                <td style="max-width: 120px;">
                                    <div style="height: 80px; width: 80px; overflow: hidden; margin: 17px 15px 17px 20px;">
                                        <?php the_content(); ?>
                                        <!-- <img  width="auto" height="80" src="<?php bloginfo('template_url'); ?>/images/ferias-praia.png"/> -->
                                    </div>
                                </td>
