$(document).ready(function() {
    ...
    if ($('#nav-menu-container').length) {
        ...
        $('body').prepend('<button type="button" id="mobile-nav-toggle"><svg class="lnr lnr-menu"><use xlink:href="#lnr-menu"></use></svg></button>');
    ...
    $(window).scroll(function() {
        if ($(this).scrollTop() > 200) {
            // $('.main-menu').css('border-bottom','1px solid #5a189a');
            $('#header').addClass('header-scrolled');
            
            $('.header-cel').css('display', 'block');
            $('.header-normal').css('display', 'none');
        } else {
            // $('.main-menu').css('border-bottom','1px solid #f1eef7');
            $('.header-cel').css('display', 'none');
